...
const Navigation = () => {
  ...
  return (
    <nav
      className="fixed top-0 left-1 right-1 z-50 transition-all duration-500 ease-out max-w-6xl mx-auto mt-2 bg-white/5 backdrop-blur-md border border-white/20 rounded-[1rem] shadow-[0_8px_32px_0_rgba(0,0,0,0.37)]"
    >
